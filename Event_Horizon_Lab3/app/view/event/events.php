<div class="events-container">
            ...
            <table class="table">
                ...
                <?php foreach ($events as $event): ?>
                    <?php 
                        ...
                        $statusColor = $percentage >= 90 ? 'var(--danger)' : 
                    ...
                    <tr class="event-row">
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="<?= htmlspecialchars(BASE_PATH) ?>/Index.php?controller=event&action=attendees&id=<?= (int)($event['event_id'] ?? 0) ?>" 
                                   class="action-btn view-btn" title="View Attendees">
                                    👁️
                                </a>
                                <button class="action-btn edit-btn" title="Edit Event" onclick="alert('Edit feature coming soon!')">
                                    ✏️
                                </button>
                            </div>
                        </td>
    ...
    <div class="quick-actions">
        ...
        <div class="action-grid">
            <button class="quick-action-card" onclick="alert('Create Event feature coming soon!')">
