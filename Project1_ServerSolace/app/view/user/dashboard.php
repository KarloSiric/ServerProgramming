<div class="main-content">
    ...
    <div class="events-grid">
        ...
        foreach ($events as $event): 
            $imagePath = '/~ks9700/iste-341/Project1/img/' . ($eventImages[$event['id']] ?? 'Project1_image1.png');
        ?>
        <div class="event-card">
            ...
            <div class="event-content">
                ...
                <div class="event-actions">
                    <a href="/~ks9700/iste-341/Project1/event/view?id=<?= $event['id'] ?>" class="btn btn-view">View Details</a>
                    <a href="/~ks9700/iste-341/Project1/event/register?id=<?= $event['id'] ?>" class="btn btn-register">
