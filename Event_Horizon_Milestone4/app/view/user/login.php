  ...
  <section class="login-card">
    ...
    <form method="post" action="<?= PROJECT_URL ?>/user/login" class="login-form">
      ...
      <div class="form-options">
        ...
        <a href="#" class="forgot-link" onclick="alert('Password reset feature coming soon!'); return false;">Forgot Password?</a>
      </div>

      <button type="submit" class="login-button">
        <span class="button-text">Sign In to Event Horizon</span><span class="button-icon">→</span>
      </button>
    </form>

    <div class="info-cards">
      <div class="info-card admin-card"><span class="card-icon">👨‍💼</span><div class="card-content"><strong>Administrators</strong><small>Access the Events Dashboard</small></div></div>
      <div class="info-card attendee-card"><span class="card-icon">👥</span><div class="card-content"><strong>Attendees</strong><small>View your personalized portal</small></div></div>
    </div>
