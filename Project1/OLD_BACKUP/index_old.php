...
final class Index {
    ...
    public static function run() {
        session_start();  // Added for login to work
        self::init();
        self::handle();
    }
    ...
    private static function init() {
        ...
        // Define constants as in: PROJETC_URL === "https://localhost/W02C2-Lab2-MVC/";
        define('PROJECT_URL', 'http://' . $_SERVER['HTTP_HOST'] . pathinfo($_SERVER['SCRIPT_NAME'], PATHINFO_DIRNAME));
        define('TITLE', 'EventPro MVC');
